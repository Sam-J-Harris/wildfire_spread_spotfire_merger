...
function [bigz,tmax] = ROSAtstep_v1_2(bigz,bigc,tmax,merdata,mcnt,J,v0,delta,alpha,beta,lambda,U,tstep,rkswt,pcswt,resl,imswt)
...
% Code:
tstepa = tstep; tstepm = 0.0025; % actual tstep value (changes if emergency RK1 used); modified tstep for RK1
if rkswt==0 % RK1
...
function olap = overlapchk(z1, z2, olapi)
