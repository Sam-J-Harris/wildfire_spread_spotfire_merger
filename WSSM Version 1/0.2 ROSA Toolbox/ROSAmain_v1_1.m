...
for m=1:steps
    tic;  % set timer.
    [bigz,tmax] = ROSAtstep_v1_1(bigz,bigc,tmax,merdata,mcnt,J,v0,delta,alpha,beta,lambda,U,tstep,rkswt,pcswt,resl,imswt); % fire time step
    bigz = ROSAsmooth_v1_1(bigz,mcnt,J,resl,inswt,imswt); % fire line smoothing
    [bigz, bigc, merdata, mcnt, J] = ROSAmerger_v1_1(bigz,bigc,merdata,mcnt,J,resl,inswt,imswt); % fire merge (and smooth if nec)
