function [resl, bigz, bigc, J] = ROSAshape_CR_v7_1(shswit,prevdata)
    resl = 100; 
    if shswit ==0
    ...
    elseif shswit==1
        load('bigz_hilton2018_fig8_csi_v7_1.mat', 'bigz');
        load('bigc_hilton2018_fig8_csi_v7_1.mat', 'bigc'); J = size(bigc,2); 
    else
