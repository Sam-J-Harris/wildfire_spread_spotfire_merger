...
function [bigZ, bigC, bigJ, merdata, tmax, rtot] = ROSAmain_fbk_v1_1(bigz,bigc,J,v0,delta,alpha,beta,lambda,U,tstep,steps,resl,rkswt,pcswt,inswt,imswt,shswt)
% ROSA main code
...
for m=1:steps
    tic;  % set timer.
    [bigz,tmax] = ROSAtstep_fbk_v1_1(bigz,bigc,tmax,merdata,mcnt,J,v0,delta,alpha,beta,lambda,U,tstep,rkswt,pcswt,resl,imswt,shswt); % fire time step
    bigz = ROSAsmooth_fbk_v1_1(bigz,mcnt,J,resl,inswt,imswt); % fire line smoothing
    [bigz, bigc, merdata, mcnt, J] = ROSAmerger_fbk_v1_1(bigz,bigc,merdata,mcnt,J,resl,inswt,imswt); % fire merge (and smooth if nec)
