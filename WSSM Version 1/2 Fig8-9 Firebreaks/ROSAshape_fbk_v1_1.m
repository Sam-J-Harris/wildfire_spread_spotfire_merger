function [resl, bigz, bigc, J] = ROSAshape_fbk_v1_1(shswt,prdt)
% ROSA shape function
...
elseif shswt == 121 || shswt==122 || shswt==123 % one fire with firebreaks: infinite wall, gap, semi-inf wall
...
elseif shswt==21 || shswt == 224 || shswt == 225 % load in previous n-shape wildfire data.
    load(prdt,'bigDataPack');
