...
tstep=0.02; steps = 10; spc=1; % size of each step, number of steps, plot spacing (1: all timesteps plotted).
...
bigDataPack = ROSAdcomp_v1_4(bigZ1, bigC1, bigJ1,merdata1,tmax1,rtot1,prdt,shswt); % compile prdt and crdt into big data pack
load('fix1_v6_t100.mat'); 
spc = 10; shswt = 21; imswt = 0; %bring in prev data (comment out)
