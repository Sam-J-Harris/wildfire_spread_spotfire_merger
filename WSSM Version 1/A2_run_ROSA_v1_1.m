...
tstep=0.001; steps = 10; spc=1; % size of each time step, number of time steps, plot spacing (1: all timesteps plotted).
...
[bigZ1, bigC1, bigJ1, merdata1] = ROSAmain_v1_1(bigz,bigc,J,v0,delta,alpha,beta,lambda,U,tstep,steps,resl,rkswt,pcswt,inswt,imswt); % main time stepping algorithm - see function.
bigDataPack = ROSAdcomp_v1_1(bigZ1, bigC1, bigJ1,merdata1,prdt,shswt); % compile previous data (if applicable) and current data into big data pack - see function.
