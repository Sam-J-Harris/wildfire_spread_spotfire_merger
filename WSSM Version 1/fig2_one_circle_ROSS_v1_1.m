...
% Figure 2 - Circle Run with relative error plotted for N=32, 64, 128
%
% Parameter values:
...
[Z1, RE1, mRE1] = ROSSmain_v1_1(32,shswt,shinp,tvec,v0,delta,alpha,beta,lambda,U);
[Z2, RE2, mRE2] = ROSSmain_v1_1(64,shswt,shinp,tvec,v0,delta,alpha,beta,lambda,U);
[Z3, RE3, mRE3] = ROSSmain_v1_1(128,shswt,shinp,tvec,v0,delta,alpha,beta,lambda,U);

bigDataPack = {Z3,tvec,RE1,RE2,RE3};
Z3 = bigDataPack{1}; tvec = bigDataPack{2}; RE1 = bigDataPack{3}; RE2 = bigDataPack{4}; RE3 = bigDataPack{5}; spc = 200;

ROSSplot_v1_1({Z3},spc,1)
ROSSplotRE_v1_1(tvec,{RE1,RE2,RE3},2)
